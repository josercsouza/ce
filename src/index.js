    ...
    var jexcel = function (el, options) {
        ...
        obj.createCell = function (i, j, value) {
            ...
            if (
                ...
                (obj.options.wordWrap == true || obj.options.columns[i].wordWrap == true || td.innerHTML.length > 200)
            ) {
                ...
                if (obj.options.columns[x].editor) {
                    ...
                    if (obj.options.columns[x].type == "hidden") {
                        ...
                        var options = {
                            ...
                            autocomplete:
                                obj.options.columns[x].autocomplete || obj.options.columns[x].type == "autocomplete" ? true : false,
                            opened: true,
                            value: value,
                            width: "100%",
                        ...
                        if (
                            ...
                            (obj.options.wordWrap == true || obj.options.columns[x].wordWrap == true)
                        ) {
                ...
                if (obj.options.columns[x].editor) {
                    ...
                    if (obj.options.columns[x].type == "checkbox" || obj.options.columns[x].type == "radio") {
                        ...
                        obj.records[y][x].children[0].checked =
                            value == 1 || value == true || value == "true" || value == "TRUE" ? true : false;
        ...
        obj.conditionalSelectionUpdate = function (type, o, d) {
            if (type == 1) {
                if (
                    obj.selectedCell &&
                    ((o >= obj.selectedCell[1] && o <= obj.selectedCell[3]) || (d >= obj.selectedCell[1] && d <= obj.selectedCell[3]))
                ) {
                    obj.resetSelection();
                    return;
                }
                ...
                if (
                    obj.selectedCell &&
                    ((o >= obj.selectedCell[0] && o <= obj.selectedCell[2]) || (d >= obj.selectedCell[0] && d <= obj.selectedCell[2]))
                ) {
                    obj.resetSelection();
                    return;
                }
        ...
        obj.setStyle = function (o, k, v, force, ignoreHistoryAndEvents) {
            ...
            var applyStyle = function (cellId, key, value) {
                ...
                if (
                    ...
                    (obj.records[cell[1]][cell[0]].classList.contains("readonly") == false || force)
                ) {
                    // Current value
            ...
            if (obj.options.allowInsertColumn == true) {
                ...
                if (obj.options.nestedHeaders && obj.options.nestedHeaders.length > 0) {
                    ...
                    if (obj.options.nestedHeaders[0] && obj.options.nestedHeaders[0][0]) {
                        for (var j = 0; j < obj.options.nestedHeaders.length; j++) {
                            var colspan =
                                parseInt(obj.options.nestedHeaders[j][obj.options.nestedHeaders[j].length - 1].colspan) + numOfColumns;
                    ...
                    if (parseInt(columnNumber) > -1) {
                        ...
                        if (obj.options.nestedHeaders && obj.options.nestedHeaders.length > 0) {
                            ...
                            if (obj.options.nestedHeaders[0] && obj.options.nestedHeaders[0][0]) {
                                for (var j = 0; j < obj.options.nestedHeaders.length; j++) {
                                    var colspan =
                                        parseInt(obj.options.nestedHeaders[j][obj.options.nestedHeaders[j].length - 1].colspan) -
                                        numOfColumns;
                                    obj.options.nestedHeaders[j][obj.options.nestedHeaders[j].length - 1].colspan = colspan;
                                    obj.thead.children[j].children[obj.thead.children[j].children.length - 1].setAttribute(
                                        "colspan",
                                        colspan
                                    );
                                }
        ...
        obj.last = function (shiftKey, ctrlKey) {
            ...
            if (
                ...
                (obj.selectedCell[1] == obj.records.length - 1 || obj.selectedCell[3] == obj.records.length - 1)
            ) {
                obj.loadPage(-1);
            } else if (obj.options.pagination > 0) {
                var pageNumber = obj.whichPage(obj.selectedCell[3]);
            ...
            if (jexcel.current.edition) {
                if (e.which == 27) {
                    ...
                    if (jexcel.current.options.columns[jexcel.current.edition[2]].type == "calendar") {
                        ...
                        jexcel.current.options.columns[jexcel.current.edition[2]].type == "dropdown" ||
                        ...
                        if (
                            (jexcel.current.options.wordWrap == true ||
                                ...
                                jexcel.current.options.data[jexcel.current.edition[3]][jexcel.current.edition[2]].length > 200) &&
                            e.altKey
                        ) {
                            ...
                            if (jexcel.current.options.editable == true) {
                                ...
                                if (jexcel.current.options.columns[columnId].type != "readonly") {
                                    ...
                                    if (e.keyCode == 32) {
                                        // Space
                                        if (
                                            jexcel.current.options.columns[columnId].type == "checkbox" ||
                                        ...
                                        ((String.fromCharCode(e.keyCode) == e.key ||
                                            String.fromCharCode(e.keyCode).toLowerCase() == e.key.toLowerCase()) &&
                        ...
                        if (rowId) {
                            if (jexcel.current.isRowMerged(rowId).length) {
                                ...
                                if (jexcel.current.dragging.element != target) {
                                    ...
                                    jexcel.current.dragging.destination = Array.prototype.indexOf.call(
